...
import { MapPin, Calendar, Search, ChevronDown, ArrowRight, Play } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#080604] w-full overflow-x-hidden font-sans">
      ...
      <section className="relative w-full h-screen min-h-screen overflow-hidden">
        {/* Video background - use multiple sources */}
          ...
          >
            <div className="bg-black/40 backdrop-blur-xl border border-white/10 p-1.5 flex flex-col lg:flex-row gap-1.5 gold-border-glow">
              ...
              <div className="flex-1 flex items-center px-5 py-3.5 border-r border-white/10">
                ...
                <select className="w-full bg-transparent border-none outline-none text-white/80 text-sm font-manrope font-light cursor-pointer" data-testid="select-city">
                  <option value="" className="bg-[#0d0b08]">Select City</option>
                  <option value="mumbai" className="bg-[#0d0b08]">Mumbai</option>
                  <option value="delhi" className="bg-[#0d0b08]">Delhi</option>
                  <option value="bangalore" className="bg-[#0d0b08]">Bangalore</option>
                  <option value="jaipur" className="bg-[#0d0b08]">Jaipur</option>
                  <option value="chennai" className="bg-[#0d0b08]">Chennai</option>
                  <option value="hyderabad" className="bg-[#0d0b08]">Hyderabad</option>
                  <option value="goa" className="bg-[#0d0b08]">Goa</option>
                  <option value="udaipur" className="bg-[#0d0b08]">Udaipur</option>
                </select>
              </div>
              {/* Event Type */}
              <div className="flex-1 flex items-center px-5 py-3.5 border-r border-white/10">
                <Search className="w-4 h-4 text-primary mr-3 shrink-0" />
                <select className="w-full bg-transparent border-none outline-none text-white/80 text-sm font-manrope font-light cursor-pointer" data-testid="select-event-type">
                  <option value="" className="bg-[#0d0b08]">Event Type</option>
                  <option value="wedding" className="bg-[#0d0b08]">Wedding</option>
                  <option value="destination-wedding" className="bg-[#0d0b08]">Destination Wedding</option>
                  <option value="live-concert" className="bg-[#0d0b08]">Live Concert</option>
                  <option value="award-show" className="bg-[#0d0b08]">Award Show</option>
                  <option value="baby-shower" className="bg-[#0d0b08]">Baby Shower</option>
                  <option value="party" className="bg-[#0d0b08]">Party</option>
                </select>
              </div>
              {/* Date */}
              <div className="flex-1 flex items-center px-5 py-3.5 border-r border-white/10">
                <Calendar className="w-4 h-4 text-primary mr-3 shrink-0" />
                <input type="date" className="w-full bg-transparent border-none outline-none text-white/60 text-sm font-manrope font-light" data-testid="input-date" />
              </div>
              {/* Service */}
              <div className="flex-1 flex items-center px-5 py-3.5">
                <Search className="w-4 h-4 text-primary mr-3 shrink-0" />
                <select className="w-full bg-transparent border-none outline-none text-white/80 text-sm font-manrope font-light cursor-pointer" data-testid="select-service">
                  <option value="" className="bg-[#0d0b08]">Select Service</option>
                  <option value="venues" className="bg-[#0d0b08]">Venues</option>
                  <option value="photography" className="bg-[#0d0b08]">Photography</option>
                  <option value="makeup" className="bg-[#0d0b08]">Makeup</option>
                  <option value="catering" className="bg-[#0d0b08]">Catering</option>
                  <option value="decorator" className="bg-[#0d0b08]">Decorator</option>
                  <option value="entertainment" className="bg-[#0d0b08]">Entertainment</option>
                  <option value="wedding-planner" className="bg-[#0d0b08]">Wedding Planner</option>
                </select>
              </div>
              {/* CTA */}
              <button
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
              ...
              {["Wedding Venues", "Photography", "Bridal Makeup", "Entertainment", "Catering"].map(tag => (
                <span key={tag} className="px-3 py-1 text-xs font-manrope text-white/50 border border-white/10 hover:border-primary/40 hover:text-primary/80 cursor-pointer transition-all duration-300 backdrop-blur-sm">
                  {tag}
                </span>
              ))}
            </div>
      ...
      <section className="py-28 px-6 md:px-12" style={{background: '#080604'}}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            {/* Three smaller cards */}
            {[
              {img:"https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=700&q=80", type:"Banquet", title:"Banquet Halls", cities:["Mumbai","Delhi","Pune"]},
              {img:"https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=700&q=80", type:"Garden", title:"Marriage Garden / Lawns", cities:["Jaipur","Delhi","Hyderabad"]},
              {img:"https://images.unsplash.com/photo-1582719508461-905c673771fd?w=700&q=80", type:"Resort", title:"Destination Resorts", cities:["Goa","Udaipur","Mussoorie"]},
            ].map((card, i) => (
              <motion.div key={i} className="relative overflow-hidden group cursor-pointer luxury-card" style={{minHeight: '280px'}} whileHover={{scale:1.01}} transition={{duration:0.4}}>
            ...
            {[
              {
                ...
                desc: "End-to-end meticulous planning by our luxury expert team"
              },
              {
                img: "https://images.unsplash.com/photo-1606216794074-735e91aa2c92?w=700&q=80",
                title: "Photography & Films",
                desc: "Cinematic captures of your most treasured moments"
              },
              {
                img: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=700&q=80",
                title: "Bridal Artistry",
                desc: "Top makeup artists curating your flawless special day look"
              }
            ].map((service, i) => (
              <motion.div key={i} variants={staggerItem} className="luxury-card p-6 flex flex-col group cursor-pointer hover:gold-glow rounded-sm">
          ...
          >
            {[
              ...
              },
              {
                ...
                sub: ["Indian/Traditional", "Chinese", "Jain Food", "Punjabi", "South Indian"]
              },
              {
                name: "Photography",
                num: "04",
              ...
              },
              {
                ...
                sub: ["DJ", "Comedian", "Magician", "Tarot Card Reader"]
              }
            ].map((vendor, i) => (
              <motion.div key={i} variants={staggerItem} data-testid={`card-category-${vendor.name.toLowerCase()}`} className="group relative overflow-hidden rounded-sm h-[400px] cursor-pointer border border-transparent hover:gold-border-glow transition-all duration-500">
      ...
      <section className="py-28 px-6 md:px-12 bg-[#0d0a07]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            ...
            <Button variant="outline" className="hidden md:flex rounded-sm border-primary/50 text-primary font-cinzel text-[10px] tracking-[0.2em] uppercase hover:bg-primary hover:text-black transition-colors" data-testid="btn-all-weddings">
              View All Galleries
            </Button>
          </div>
          ...
          >
            {[
              ...
              <motion.div key={i} variants={staggerItem} className="group cursor-pointer break-inside-avoid">
                <div className={`overflow-hidden rounded-sm mb-4 relative ${wedding.tall ? 'aspect-[3/4]' : 'aspect-square'} border border-transparent group-hover:border-primary/40 transition-colors duration-500`}>
                  ...
                  {/* Decorative quotes */}
                  <div className="absolute top-4 left-4 font-cormorant text-4xl text-primary/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    "
                  </div>
                </div>
          ...
          <div className="mt-12 text-center md:hidden">
            <Button variant="outline" className="rounded-sm border-primary/50 text-primary font-cinzel text-[10px] tracking-[0.2em] uppercase hover:bg-primary hover:text-black transition-colors w-full" data-testid="btn-all-weddings-mobile">
              View All Galleries
            </Button>
          </div>
        </div>
      ...
      <section className="py-28 px-6 md:px-12 bg-[#050403] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                text: "The planning was flawless. Every detail was curated with such precision and elegance. Our guests are still talking about the magnificent decor and seamless experience.",
                name: "Rohan & Sneha",
                date: "Married in Jaipur"
              },
              {
                text: "Finding vendors through BMS was the best decision. The platform's luxury partners delivered beyond our wildest expectations. A truly 5-star experience from start to finish.",
                name: "Vikram & Aisha",
                date: "Married in Udaipur"
              },
              {
                text: "They understood our vision for a minimalist yet opulent celebration immediately. The venue recommendation was breathtaking and the execution was pure perfection.",
                name: "Karan & Meera",
                date: "Married in Goa"
              }
            ].map((review, i) => (
              ...
              >
                ...
                <p className="font-cormorant italic text-xl text-white/80 leading-relaxed mb-10 flex-grow relative z-10">
                  {review.text}
                </p>
